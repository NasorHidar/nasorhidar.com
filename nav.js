  ...
  <nav id="navbar" class="fixed top-0 left-0 w-full z-50 transition-all duration-500">
    <div id="nav-inner" class="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between transition-all duration-300">
      <a href="index.html" class="flex items-center gap-1">
        <span class="text-2xl font-black tracking-tight text-white font-['Inter']">NASOR<span class="text-emerald-400">.</span></span>
      </a>
      <div class="hidden md:flex items-center gap-8">
        ...
        <a id="hire-me-btn" href="index.html#contact" class="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-sm font-bold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/30 hover:-translate-y-0.5">Hire Me</a>
      </div>
    ...
    <div id="mobile-menu" class="md:hidden hidden flex-col border-t border-slate-800 bg-slate-950/98 backdrop-blur-xl">
      <div class="max-w-7xl mx-auto px-6 py-4 flex flex-col gap-1">
        ...
        <a id="hire-me-mobile" href="index.html#contact" class="mt-3 text-center py-3 bg-emerald-500 text-slate-950 font-bold rounded-xl text-sm">Hire Me</a>
      </div>
    </div>
  </nav>`;
